...
public class Multiplayer {
	...
	while(true) {	
		try {
			/*  Game board should be looking like this. And the indexes for the players will be like this as well
			...
			while(true) {
				...
				System.out.println("\r\n 							      PLAYER 2 : Place your move(1-9)");
				Scanner botTurn= new Scanner(System.in);
				int botMove = botTurn.nextInt() ;
				while(playerMoves.contains(botMove) || botMoves.contains(botMove)) {
				
					 botMove = botTurn.nextInt() ;
				}
